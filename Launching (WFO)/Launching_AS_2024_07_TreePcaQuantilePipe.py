import sys
sys.path.insert(0, '..')
from Strategies.AS_2024_07_TreePcaQuantile import *
...
WFO = WalkForwardOptimization(df, TreePcaQuantilePipe, params_fixed, params_range,length_train_set=5_000, randomness=1.00)
