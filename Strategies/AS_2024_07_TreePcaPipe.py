...
class TreePcaPipe:
    ...
    def get_features(self, data_sample):
        ...
        data_sample["candle_way_l1"] = data_sample["candle_way"].shift(1)
        data_sample["filling_l1"] = data_sample["filling"].shift(1)
        data_sample["amplitude_l1"] = data_sample["amplitude"].shift(1)
        data_sample["candle_way_l2"] = data_sample["candle_way"].shift(2)
        data_sample["filling_l2"] = data_sample["filling"].shift(2)
        data_sample["amplitude_l2"] = data_sample["amplitude"].shift(2)
    ...
    def train_model(self):
        ...
        params = {
            "pca__n_components": [8],  # Number of components to keep
